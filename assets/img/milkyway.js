function MilkyWay(t) {
    this.init = function () {
        ...
        t = t ? document.querySelector(t) : this, t.addEventListener("mousemove", function (t) {
            ...
            100 > n ? (a.freezed = !0, a.speedOffset = Math.min(.2, r / 13e3)) : (a.freezed = !1, a.speedOffset = Math.min(.2, r / 5e3) )
        })
        ...
        for (var e = 0; i > e; e++) {
            var n = {};
            n.color = [231, 8, 8], n.angle = Math.ceil(360 * Math.random()), n.opacity = this.random(.15, .85), n.width = this.randomDistribution(3, 2, 2, 2, 2, 1), n.length = n.width / 2e3, n.trailLength = 0, n.radius = this.randomDistribution(this.randomInt(0, a), this.randomInt(25, a), this.randomInt(45, a), this.randomInt(50, a)), n.speed = Math.abs((20 / n.radius + Math.random()) / 10), this.stars.push(n)
        }
