    ...
    <div class="single-project__container" :class="{ 'single-project__container_white-letters-theme': isWhiteColored}">
      <div class="single-project__content-wrap">
        ...
        <div class="contribution-vidget">
          <svg class="contribution-vidget__img" :class="[project.contributionVidgetColor === '#ec1c24' ? 'contribution-vidget__img_red' : (project.contributionVidgetColor === '#000000' ? 'contribution-vidget__img_black' : 'contribution-vidget__img_gray')  ]" width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
