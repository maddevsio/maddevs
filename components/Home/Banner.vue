<template>
  <section id="banner" class="banner">
    <div class="video-background">
      <video autoplay muted loop id="BgVideo" :poster="require('../../assets/img/Home/jpg/posters/cover_video_1366x610.jpg')">
      ...
      &_sidebar {
        ...
        &-content {
          ...
          .sidebar-content-list {
            ...
            margin-top: 30px;
            .sidebar-content-list_items {
              padding: 5px 20px;
              cursor: pointer;
              position: relative;
              &:hover {
                background-color: rgba(#281b26, .4);
                .sidebar-content-list_item--active {
                  opacity: 0.65;
                }
                &::before {
                  content: '';
            ...
            .slack-selected {
              background-color: #2a9889;
              &:hover {
                background-color: #2a9889;
              }
            }
            .sidebar-content-list_item1 {
              width: 68px;
              height: 5px;
              background-color: $text-color--white;
              border-radius: 5px;
