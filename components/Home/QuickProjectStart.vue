<template>
  <section ref="quick" id="quick" class="quick">
    <div class="container">
        ...
        <div class="quick-list_item" data-text="1">
          <svg class="quick-line" width="272px" height="37px" viewBox="0 0 272 37" version="1.1">
            <g id="quick-line1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
              <path class="quick-line_dashed" d="M272,35.547612 C269.37434,34.0202917 267.914591,33.176634 267.620751,33.0166391 C230.621067,12.8703779 185.18463,1 136.074439,1 C84.9416922,1 37.7915311,13.8682518 0,35.547612" stroke="#ec2227" fill-rule="nonzero"></path>
              <path :class="{ 'quick-line_white_run': lineAnimated }" class="quick-line_white quick-line_white1" d="M272,35.547612 C269.37434,34.0202917 267.914591,33.176634 267.620751,33.0166391 C230.621067,12.8703779 185.18463,1 136.074439,1 C84.9416922,1 37.7915311,13.8682518 0,35.547612" stroke="#fff" stroke-width="5" fill="none"></path>
            </g>
          </svg>
        ...
        <div class="quick-list_item" data-text="2">
          <svg class="quick-line" width="272px" height="37px" viewBox="0 0 272 37" version="1.1">
            <g id="quick-line2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
              <path class="quick-line_dashed" d="M272,35.547612 C269.37434,34.0202917 267.914591,33.176634 267.620751,33.0166391 C230.621067,12.8703779 185.18463,1 136.074439,1 C84.9416922,1 37.7915311,13.8682518 0,35.547612" stroke="#ec2227" fill-rule="nonzero"></path>
              <path :class="{ 'quick-line_white_run': lineAnimated }" class="quick-line_white quick-line_white2" d="M272,35.547612 C269.37434,34.0202917 267.914591,33.176634 267.620751,33.0166391 C230.621067,12.8703779 185.18463,1 136.074439,1 C84.9416922,1 37.7915311,13.8682518 0,35.547612" stroke="#fff" stroke-width="5" fill="none"></path>
            </g>
          </svg>
        ...
        <div class="quick-list_item" data-text="3">
          <svg class="quick-line" width="272px" height="37px" viewBox="0 0 272 37" version="1.1">
            <g id="quick-line3" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
              <path class="quick-line_dashed" d="M272,35.547612 C269.37434,34.0202917 267.914591,33.176634 267.620751,33.0166391 C230.621067,12.8703779 185.18463,1 136.074439,1 C84.9416922,1 37.7915311,13.8682518 0,35.547612" stroke="#ec2227" fill-rule="nonzero"></path>
              <path :class="{ 'quick-line_white_run': lineAnimated }" class="quick-line_white quick-line_white3" d="M272,35.547612 C269.37434,34.0202917 267.914591,33.176634 267.620751,33.0166391 C230.621067,12.8703779 185.18463,1 136.074439,1 C84.9416922,1 37.7915311,13.8682518 0,35.547612" stroke="#fff" stroke-width="5" fill="none"></path>
            </g>
          </svg>
        ...
        <div class="quick-list_item" data-text="4">
          <svg class="quick-line" width="272px" height="37px" viewBox="0 0 272 37" version="1.1">
            <g id="quick-line4" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
              <path class="quick-line_dashed" d="M272,35.547612 C269.37434,34.0202917 267.914591,33.176634 267.620751,33.0166391 C230.621067,12.8703779 185.18463,1 136.074439,1 C84.9416922,1 37.7915311,13.8682518 0,35.547612" stroke="#ec2227" fill-rule="nonzero"></path>
              <path :class="{ 'quick-line_white_run': lineAnimated }" class="quick-line_white quick-line_white4" d="M272,35.547612 C269.37434,34.0202917 267.914591,33.176634 267.620751,33.0166391 C230.621067,12.8703779 185.18463,1 136.074439,1 C84.9416922,1 37.7915311,13.8682518 0,35.547612" stroke="#fff" stroke-width="5" fill="none"></path>
            </g>
          </svg>
...
export default {
  ...
  created() {
    if (process.browser) { 
      window.addEventListener('scroll', this.getPositionSection);
    }
  },
  beforeDestroy() {
    if (process.browser) {
      window.removeEventListener('scroll', this.getPositionSection);
    }
  },
  mounted() {
    if (process.browser) {
  ...
  methods: {
    getPositionSection() {
      if (window.scrollY + 700 >= this.$refs.quick.offsetTop) {
