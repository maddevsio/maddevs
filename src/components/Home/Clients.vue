      ...
      <div class="clients_wrap" :class="{ open_wrap: OpenWrap }">
        ...
        <div class="clients_wrap-icons">
          <div class="clients_wrap-icons_row">
            ...
            <a>
              <img src="../../assets/img/svg/clients/zofice.svg" alt="zofice">
            </a>
            <a>
              <img src="../../assets/img/svg/clients/iotsploit.svg" alt="iotsploit">
            </a>
            <a>
              <img src="../../assets/img/svg/clients/kaf.svg" alt="kaf">
            </a>
            <a>
            ...
            <a class="small-image">
              <img src="../../assets/img/svg/clients/silkroadexplore.svg" alt="silkroadexplore">
            </a>
            <a>
            ...
            <a>
              <img src="../../assets/img/svg/clients/inn-4-pet.svg" alt="inn-4-pet">
            </a>
            <a>
              <img src="../../assets/img/svg/clients/socialshopwave.svg" alt="socialshopwave">
            </a>
            <a class="tengri">
            ...
            <a class="small-image">
              <img src="../../assets/img/svg/clients/smk.svg" alt="smk">
            </a>
            <a class="small-image">
              <img src="../../assets/img/svg/clients/pickd.svg" alt="pickd">
            </a>
             <a class="small-image">
