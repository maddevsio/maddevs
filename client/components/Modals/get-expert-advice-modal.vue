  ...
  <div class="form technology-stack"> 
    <div class="fields-list">
      ...
      <div class="modal-field-item field-item">
        ...
        <textarea @input="$v.questionsOnItConsulting.$touch" type="text" class="modal-entry-field entry-field textarea" placeholder="Tell us how we can help you…" v-model="questionsOnItConsulting"/>
        <!-- Erros -->
