  ...
  <section id="gdpr">
    <div class="container">
      ...
      <div class="agreement-page__content">
        <p class="agreement-page__text doc-text">
        ...
        <p class="agreement-page__text doc-text">
          <span class="agreement-page__text agreement-page__text--bold">Important note.</span> Our software development and infrastructure optimization departments
        ...
        <h5 class="agreement-page__sec-title">Data Processing Documentation</h5>
        <p class="agreement-page__paragraph paragraph">
          ...
          European Economic Area. We are also ready to provide our <a class="agreement-page__link" href="https://gdpr.eu/what-is-data-processing-agreement/">Data Processing Addendum (DPA)</a>
        ...
        <p class="agreement-page__paragraph paragraph">
          ...
          <a class="agreement-page__link" href="mailto:rock@maddevs.io">rock@maddevs.io</a
          >.
        </p>
        <h5 class="agreement-page__sec-title">
          Cookie Usage
        ...
        <p class="agreement-page__paragraph agreement-page__paragraph--bold paragraph">
          We appreciate your collaboration and openness with regard to any legal issues!
        </p>
        <p class="agreement-page__paragraph agreement-page__paragraph--bold agreement-page__paragraph--italic paragraph">
          Team Mad Devs
        </p>
      </div>
    </div>
