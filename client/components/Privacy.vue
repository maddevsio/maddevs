  ...
  <section id="privacy">
    <div class="container">
      <div class="agreement-page__header">
        <h3 class="agreement-page__title title">
          Privacy Policy: Website Acceptable Use Terms
        </h3>
        <img
          class="agreement-page__image"
          src="@/assets/img/common/docs.svg"
          alt="Privacy image"
        />
      </div>
      <div class="agreement-page__content">
        <p class="agreement-page__text doc-text agreement-page__break-main-paragraph paragraph">
        ...
        <p class="agreement-page__text doc-text agreement-page__break-main-paragraph paragraph">
          <a class="agreement-page__link" target="_blank" href="https://maddevs.io"
            >https://maddevs.io
          </a>
          and
          <a
            class="agreement-page__link"
            target="_blank"
            href="https://maddevsgroup.co.uk/"
            >https://maddevsgroup.co.uk/
          </a>
          are websites operated by Mad Devs Group Ltd ("We"). We are registered
          in England and Wales under a company number 11793394 and have our
          registered office at Salisbury House, Station Road, Cambridge, CB1
          2LA, United Kingdom.
        </p>
        <p class="agreement-page__text doc-text paragraph">
        ...
        <h5 class="agreement-page__sec-title">
          By using our site you accept these terms
        </h5>
        <p class="agreement-page__paragraph paragraph">
        ...
        <p class="agreement-page__paragraph paragraph agreement-page__break-paragraph">
          You may use our site only for lawful purposes. You may not use our
          site:
        </p>
        <ul class="agreement-page__list-wrap paragraph">
          <li class="agreement-page__list">
        ...
        <p class="agreement-page__paragraph paragraph">
          You also agree not to reproduce, duplicate, copy or re-sell any part
          of our site in contravention of the provisions of our terms of website
          use. Not to access without authority, interfere with, damage or
        ...
        <h5 class="agreement-page__sec-title agreement-page__sec-title">
          Cookie Policy
        </h5>
        <p class="agreement-page__paragraph paragraph">
        ...
        <p class="agreement-page__paragraph paragraph">
          <span class="agreement-page__paragraph agreement-page__paragraph--bold paragraph"
        ...
        <div class="agreement-page__term-container">
          <div class="agreement-page__term-title paragraph">
            Personal Data
          </div>
          <div class="agreement-page__term-description paragraph">
        ...
        <div class="agreement-page__term-container">
          ...
          <div class="agreement-page__term-description paragraph">
            ...
            browsing our site or from our service infrastructure itself (for
        ...
        <h5
          class="agreement-page__sec-title agreement-page__sec-title agreement-page__sec-title--multi-title"
        >
          Personal Data
        </h5>
        <p class="agreement-page__paragraph paragraph">
        ...
        <p class="agreement-page__paragraph paragraph">
          If you are from the European Economic Area (EEA), Mad Devs Group Ltd
        ...
        <p class="agreement-page__paragraph paragraph">
          Mad Devs Group Ltd will retain your Personal Data only for as long as
        ...
        <p class="agreement-page__paragraph paragraph">
          Mad Devs Group Ltd will also retain Usage Data for internal analysis
        ...
        <h5 class="agreement-page__sec-title agreement-page__sec-title--multi-title">
          Disclosure for Law Enforcement
        </h5>
        <p class="agreement-page__paragraph paragraph">
          Under certain circumstances, Mad Devs Group Ltd may be required to
        ...
        <p class="agreement-page__paragraph paragraph">
          Mad Devs Group Ltd may disclose your Personal Data in limited
        ...
        <p class="agreement-page__paragraph paragraph">
          ...
          certain data protection rights. Mad Devs Group Ltd aims to take
        ...
        <p class="agreement-page__paragraph paragraph">
          ...
          on
          <a class="agreement-page__link" href="mailto:rock@maddevs.io"
            >rock@maddevs.io</a
          >
        </p>
        <p class="agreement-page__paragraph paragraph">
