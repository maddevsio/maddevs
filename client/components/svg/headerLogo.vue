...
export default {
  ...
  methods: {
    ...
    changeLogoState(scrollTop) {
      if (this.isCasePage) {
        this.toggleState(scrollTop, this.$props.scrollTop);
      } else {
        this.toggleState(scrollTop, 10);
      }
    },
    toggleState(scrollTop, value) {
      if(scrollTop >= value) {
