    ...
    <div class="container">
      ...
      <div class="cluster-navigation__inner">
        <ol class="cluster-navigation__column cluster-navigation__column--left">
          <router-link :to="`/customer-university/${post.cu_post.uid}/`" class="cluster-navigation__nav-item" :class="isCurrent(post)" v-for="(post, index) in leftColumnPosts" :key="post.cu_post.id">
        ...
        <ol class="cluster-navigation__column cluster-navigation__column--right" :start="leftColumnPosts.length + 1">
          <router-link :to="`/customer-university/${post.cu_post.uid}/`" class="cluster-navigation__nav-item" :class="isCurrent(post)" v-for="(post, index) in rightColumnPosts" :key="post.cu_post.id">
