  ...
  <section id="faq" class="faq">
    <div class="container">
      ...
      <div class="faq__content">
        ...
        <div class="faq__text-wrapper faq__text-wrapper-list">
          ...
          <ul class="faq__list-wrap faq__paragraph">
            ...
            <li class="faq__list">Phone Call via +44 20 3984 8555</li>
            <li class="faq__list">Text message via Facebook Messenger, Telegram, Whatsapp, or WeChat.</li>
          </ul>
        </div>
      </div>
    </div>
