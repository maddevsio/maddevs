  ...
  <section id="faq" class="faq">
    <div class="container">
      ...
      <div class="faq__content">
        <h2 id="how-many-people-work-at-your-company?" class="faq__sec-title faq__sec-title-first">How many people work at your company?</h2>
        ...
        <h2 id="what-time-zone-does-your-team-operate-in?" class="faq__sec-title">What time zone does your team operate in?</h2>
        <p class="faq__paragraph">
        ...
        <h2 id="what-types-of-projects-you-do-not-work-on?" class="faq__sec-title">What types of projects you do NOT work on?</h2>
        <p class="faq__paragraph">
        ...
        <h2 id="where-can-i-find-the-project-portfolio-of-your-company?" class="faq__sec-title">Where can I find the project portfolio of your company?</h2>
        <p class="faq__paragraph">
        ...
        <p class="faq__paragraph faq__paragraph-margin">
          The <span class="faq__nowrap">Mad Devs</span> team has worked with Clutch.co, Teacherly, Guardrails, GoDee, <span class="faq__nowrap">Sir John Monash Centre</span>, Eatigo, Alfabank, Admitad, Triggermesh, and many other companies ensuring that hundreds of thousands of people enjoy apps and services they use on a daily basis.
        </p>
        ...
        <h2 id="what-details-do-you-need-from-me-to-discuss-my-project-&-start-work?" class="faq__sec-title">What details do you need from me to discuss my <span class="faq__nowrap">project & start</span> work?</h2>
        <p class="faq__paragraph">
        ...
        <h2 id="how-much-does-software-development-cost?-how-do-you-charge?" class="faq__sec-title">How much does software development cost? How do you charge?</h2>
        <p class="faq__paragraph">
        ...
        <h2 id="how-do-you-ensure-security-for-confidential-information?-do-you-work-under-nda?" class="faq__sec-title">How do you ensure security for confidential information? Do you work under NDA?</h2>
        <p class="faq__paragraph">
        ...
        <h2 id="how-do-you-mitigate-the-risks-related-to-intellectual-property-ownership?" class="faq__sec-title">How do you mitigate the risks related to intellectual property ownership?</h2>
        <p class="faq__paragraph">
        ...
        <h2 id="what-if-my-question-is-not-answered-on-this-page?" class="faq__sec-title">What if my question is not answered on this page?</h2>
        <p class="faq__paragraph">
