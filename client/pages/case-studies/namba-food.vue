<template>
  <main class="main case">
    ...
    <section class="container_regular">
      ...
      <Card class="background-color-silver">
        ...
        <TextParagraph>
          ...
          payment system of the app itself. Such API benefits businesses as end-users use the payment
          method defined by the mobile app. At the moment, Mbank by Commercial bank Kyrgyzstan and
          Balance by Beeline telecommunication service provider have successfully integrated Namba Food
          API into their mobile apps.
        </TextParagraph>
      </Card>
    </section>
    <section class="container_regular">
      <h2 class="title_h2 m-96_top  m-12_bottom text-align-center">High-level system overview</h2>
      ...
      <div class="columns_container m-96_bottom">
        ...
        <Card class="background-color-silver">
          ...
          <TextParagraph class="m-24_bottom">
            ...
            a panel makes it easy to overview orders'
            statuses, make required corrections, and
    ...
    <section class="container_regular">
      ...
      <h3 class="title_h3 m-96_top m-48_bottom">Technologies used for the Namba Food project</h3>
      <ListTechnologies>
    ...
    <section class="container_regular">
      ...
      <h4 class="title_h4 m-72_top m-12_bottom">Transparent communication</h4>
      <TextParagraph>
    ...
    <section class="container_regular">
      <h2 class="title_h2 m-96_top m-24_bottom">Nationwide success and day to day improvements</h2>
      <TextParagraph>
