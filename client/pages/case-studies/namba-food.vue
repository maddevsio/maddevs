  ...
  <main class="main case">
    ...
    <section class="case_body" ref="caseBody">
      ...
      <section class="container_regular">
        ...
        <TextParagraph class="m-24_bottom media-m-12_bottom">
          Customer support challenge: The lack of transparent status updates led to the majority of users calling to check the delivery status.
        </TextParagraph>
        <TextParagraph class="m-24_bottom media-m-12_bottom">
          Business challenge: A continuously growing number of customer support teams occurred in high operational expenses.
        </TextParagraph>
