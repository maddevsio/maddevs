<template>
  <main class="main case">
    ...
    <TextQuoteBox>
      <div class="case_blockquote__item">— Tom, have you seen that ticket saying that you need to remove the photo of
        one of our founders from the
        website? It has been on the backlog for three days already. Could you fix it?
      </div>
      <div class="case_blockquote__item">— My tests have fallen, I will fail the sprint if I get distracted. Do it
        yourself.
      </div>
    ...
    <TextParagraph>
      ...
      in-house team then develops a customized website with branded identity, product lists with pictures and prices,
    ...
    <TextParagraph>
      ...
      in their city or country. Namba Food takes responsibility for maintaining servers and websites and helps with the
