export const meta = {
  ...
  yourcast: {
    ...
    scripts: [
      {
        type: 'application/ld+json',
        innerHTML: '{"@context": "https://schema.org", "@type": "WebPage", "name": "Mad Devs Case Study: YourcastTV - online video streaming platform", "description": "OTT-like streaming platform case study. Read how Mad Devs developed an online video streaming service for isolated groups of people feeling homesick.", "publisher": {"@type": "ProfilePage", "name": "Mad Devs Group LTD"}}',
      },
    ],
  },
}
...
export const buildHead = ({
  title, description, url, image, scripts = 'https://maddevs.io/Open-Graph.png',
}) => ({
  title,
  meta: [
